 ...
 * HINT: Step 1: Transpose the matrix (swap matrix[i][j] with matrix[j][i] for i < j).
 *       Step 2: Reverse each row. This achieves a 90-degree clockwise rotation.
 *       Alternatively, rotate layer by layer from outside in using 4-way swaps.
 *
 * TIME: O(n^2) | SPACE: O(1) in-place
 */
public class RotateImage {
    public void rotate(int[][] matrix) {
        // TODO: Implement transpose + reverse rows for 90-degree clockwise rotation
    }
}
